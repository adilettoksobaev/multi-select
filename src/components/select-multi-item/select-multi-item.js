...
import './select-multi-item.css';

const SelectMultiItem = ({value, onDelete}) => {

    return (
        <span>
            <div className="select-multi__value">{ value }</div>
            <div className="select-multi__remove" onClick={onDelete}>
